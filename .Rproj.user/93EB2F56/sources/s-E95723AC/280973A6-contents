...
setClass("escoParams",
         ...
         prototype = prototype(mean.rate = 0.3,
                               mean.shape = 0.6,
                               mean.dens = density(log(rgamma(10000, rate = 0.3,
                                                              shape = 0.6))),
                               mean.method = "fit",
                               lib.loc = 11,
                               lib.scale = 0.2,
...
#' The RealDropParams class
#'
#' S4 class that holds parameters for the RealDrop simulation.
#'
#' @section Parameters:
#'
#' The RealDrop simulation requires the following parameters:
#'
#' \describe{
#'     \item{\code{nGenes}}{The number of genes to simulate.}
#'     \item{\code{nCells}}{The number of cells to simulate.}
...
#' }
#'
#' For details of the RealDrop simulation
#' see \code{\link{RealDropSimulate}}.
#'
#' @name RealDropParams
#' @rdname RealDropParams
#' @aliases RealDropParams-class
#' @exportClass RealDropParams
#' @import ape
setClass("RealDropParams",
         contains = "Params",
         slots = c(nGenes = "numeric",
                   nCells = "numeric",
                   genethred = "numeric",
         ...
         prototype = prototype(nGenes = 200,
                               nCells = 100,
                               genethred = 0.95,
                               cellthred = 0.6,
                               down.mean = 10,
