...
```{r knitr-options, echo = FALSE, message = FALSE, warning = FALSE, eval = FALSE}
...
```{r escoSimulate, warning = FALSE, eval = FALSE}
...
```{r escoSimulate1, warning = FALSE, eval = FALSE}
...
```{r escoSimulate2, warning = FALSE, eval = FALSE}
...
```{r simulate single random corr, warning = FALSE, fig.height = 4, fig.width = 10, eval = FALSE}
...
```{r, warning = FALSE, fig.height = 4, fig.width = 10, eval = FALSE}
# plotting the GCN
...
```{r simulate single given corr, warning = FALSE, fig.height = 4, fig.width = 10, eval = FALSE}
sim <- escoSimulateSingle(nGenes = 100, nCells = 50, 
...
```{r, warning  = FALSE, fig.height = 3, fig.width = 10, eval = FALSE}
# plotting the GCN
simparams = metadata(sim)$Params
rholist = slot(simparams,"corr")
corrgenes = rownames(rholist[[1]])
...
```{r groups, warning = FALSE, fig.height = 6, fig.width = 10, eval = FALSE}
...
```{r tree, warning  = FALSE, eval = FALSE}
#generate the tree
yaml="
    name: All
    Group1:
...
```{r, warning  = FALSE, fig.height = 7, fig.width = 10, eval = FALSE}
# simulation
...
```{r paths, warning=FALSE, fig.height = 3, fig.width = 4, eval = FALSE}
